...
const FALLBACK_CSV = `8/22,部屋,整理番号,予約状況,人数,,8/23,部屋,整理番号,予約名（カタカナ）,人数
...
const CLASSROOM_INFO = {
    '図書室': '古い紙束と知恵が層を成す静けさの奥で、頁の隙間で記憶が囁く。',
    '理科室': '覗き込む顕微鏡の深淵で、まだ形にならない論理が揺れている。',
    '美術室': '絵の裏で色彩が現実を塗り替える場所。見たものだけが全てではない。',
    '音楽室': '旋律を狂わせる不協和音が、五線譜の上で真実を踊らせる。',
};
